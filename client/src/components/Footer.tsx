      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            ...
            />
            <p className="text-sm text-gray-400 mt-4" data-testid="text-footer-company">
              PT Ambivers Indonesia Group
            </p>
            <p className="text-sm text-gray-400 mt-4" data-testid="text-footer-address">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="#program" className="text-sm text-gray-400 hover:text-[#FFC700] transition-colors" data-testid="link-footer-program">
                  Program
                </Link>
              </li>
              <li>
                <Link href="#tentang-kami" className="text-sm text-gray-400 hover:text-[#FFC700] transition-colors" data-testid="link-footer-tentang-kami">
                  Tentang kami
                </Link>
              </li>
              <li>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-white">Kemitraan</h4>
            <ul className="space-y-3">
              <li>
                <a 
              ...
              <li>
                <Link href="/coming-soon" className="text-sm text-gray-400 hover:text-[#FFC700] transition-colors" data-testid="link-footer-daftar">
                  Daftar
                </Link>
              </li>
              <li>
                <Link href="/coming-soon" className="text-sm text-gray-400 hover:text-[#FFC700] transition-colors" data-testid="link-footer-masuk">
                  Masuk
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-[#FFC700] transition-colors"
